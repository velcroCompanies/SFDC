    ...
    calculateTooltipPosition: function(component) {
        ...
        if (placement === 'right') {
            ...
            if ((containerLeft + tooltipXPos) < 4) {
                ...
                var adjustment = (containerRight + Math.abs(tooltipXPos)) - (window.innerWidth - 4); // eslint-disable-line
            ...
            if ((containerLeft + tooltipXPos) < 4) {
                var adjustment = Math.abs(containerLeft + tooltipXPos) + 4; // eslint-disable-line
