({
    ...
    areaChart: function (component, helper) {
        ...
        innerCircles.on('mouseover', $A.getCallback(function (d) {
            ...
            if(yDataType === 'number'){
                ...
                var formatPattern = yDataType === 'date' ? 'EEEE MMM dd, yyyy' : 'EEEE MMM dd, yyyy hh:mm A';  // eslint-disable-line
    ...
    barChart: function (component, helper) {
        ...
        var stringDomain = component.get('v.data').map(function (dataPoint) {  // eslint-disable-line
        ...
        if (isVertical) {
            ...
            var thresholdYPos = yScale(component.get('v.thresholdValue'));  // eslint-disable-line
    ...
    bubbleChart: function (component, helper) {
        ...
        dataWithThreshold.push({
            y: parseInt(component.get('v.thresholdValue')) // eslint-disable-line
        })
        ...
        var yDomain = [dataYMin - yScaleSizeBuffer(), dataYMax + yScaleSizeBuffer()]; // eslint-disable-line
        ...
        circles.on('mouseover', $A.getCallback(function (d) {
            ...
            if(xAxisDataType === 'date' || xAxisDataType === 'datetime'){
                ...
                var firstTooltipLine = '<span class="sc-axis-value">' + $A.localizationService.formatDate(d.x, formatPattern) + '</span>';  // eslint-disable-line
            } else {
            ...
            if(yAxisDataType === 'date' || yAxisDataType === 'datetime'){
                var formatPattern = yAxisDataType === 'date' ? 'EEEE MMM dd, yyyy' : 'EEEE MMM dd, yyyy hh:mm A';  // eslint-disable-line
                var secondTooltipLine = '<br/><span class="sc-axis-value">' + $A.localizationService.formatDate(d.y, formatPattern) + '</span>';  // eslint-disable-line
            } else {
    ...
    gaugeChart: function (component, helper) {
        ...
        var minValue = minValue;  // eslint-disable-line
        ...
        var arc = d3.arc()
            ...
            .startAngle(function (d, i) {
                if (i === 0) {
                    ...
                    var previousSegmentStartAngle = (tickData[i - 2] + tickData[i - 1]) * range;  // eslint-disable-line
                    return degToRad(minAngle + previousSegmentStartAngle);
                }
            })
        ...
        function moveTheNeedle(value, newConfiguration) {
            function tween(d, i, a) {  // eslint-disable-line
    ...
    throwError: function (errorMessage) {
        function ErrorMessage() {
            var temp = Error.apply(this, arguments);  // eslint-disable-line
